...
//folowing are the additional code to display list of specific discount of that product
 ...
 const renderDiscounts = () => {
   ...
   console.log('discounts at renderDiscounts', discounts)
   const firstDiscount = discounts; // Get the first discount in the array
  ...
  //  console.log('firstDiscount.type', firstDiscount.type)
   return (
     <div>
       <p style={{fontSize:"14px", color:"#D7373D"}}>Extra {firstDiscount.value}{firstDiscount.type} off with code: {firstDiscount.code}</p>
     </div>
   );
 };
