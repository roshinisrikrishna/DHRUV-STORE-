        ...
        <Popover className="h-full flex">
          {({ open, close }) => {
            ...
            return (
              ...
              <Popover.Button className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none hover:text-ui-fg-base" style={{ width: "50%" }}>
                    <img
            ...
            <ul className="" style={{fontSize:"10px", letterSpacing:"0.2em", textTransform:"uppercase", fontWeight: 500, lineHeight:"2.5em"}}>
                ...
                <li>
                  <Link href="/refundandcancellation"
                                     onClick={ ()=> handleLinkClick('/refundandcancellation') } 
                  >Refund and Cancellation Policy</Link>
                  </li>
                <li><Link href="/shippinganddelivery"
                onClick={ ()=> handleLinkClick('/shippinganddelivery') } 
