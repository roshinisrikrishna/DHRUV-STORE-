...
//added import for edit address form validation
...
const EditAddress: React.FC<EditAddressProps> = ({
  ...
  //changed useForm for form validation
  const {
    register,
    handleSubmit,
    setValue,
  ...
  //changed display of the UI for form validation
  return (
    <>
      <div
        className={clsx(
...
<div className="input-wrapper" style={{ position: 'relative' }}>
        ...
        <Modal.Footer>
          <div className="flex gap-3 mt-4">
            ...
            <Button variant="secondary" onClick={clearForm} disabled={submitting}>
              Clear
            </Button>
          </div>
        </Modal.Footer>
