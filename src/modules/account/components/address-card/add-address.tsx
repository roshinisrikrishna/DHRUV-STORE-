...
//change button component based on our required UI
import Button from "@modules/common/components/button"
import Input from "@modules/common/components/input"
//Changed Modal component to change our Add Address form design  UI
import Modal from "@modules/common/components/modal"
import Plus from "@modules/common/icons/plus"
//changed spinner also
import Spinner from "@modules/common/icons/spinner"
import React, { useState, useEffect } from "react"
import { useForm } from "react-hook-form"
//adding in imports based on our customized Shipping Address Add address
import { Customer } from "@medusajs/medusa"
import { toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { phonePattern, namePattern, lastNamePattern, phoneNumberPattern } from "@lib/util/regex"

//change formValues type 
type FormValues = {
  first_name: string
  last_name: string
  city: string
...
//included AddAddressProps type for our customized form validation
...
const AddAddress: React.FC<AddAddressProps> = ({ customer }) => {
  ...
  //created new state variables for our customized form validation
  ...
  //unchanged useForm from our basic template
  // const {
  //   register,
  //   handleSubmit,
  //   formState: { errors },
  ...
  //customized useForm based on our customized form validation
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  //unchanged handleClose function
  // const handleClose = () => {
  //   reset({
  //     first_name: "",
  //     last_name: "",
  ...
  //changed handleClose function based on our customized form validation
  const handleClose = () => {
  ...
  //changed submit function based on our customized form validation
  ...
  //Added variables and state for our customized form validation
  ...
  //  if (!customer) {
  //   // Render a loading indicator, placeholder, or nothing until the customer is loaded
  //   return <div>Loading...</div>;
  // }
   //changed return of display based on our customized form validation UI
   return (
    <>
      <button
