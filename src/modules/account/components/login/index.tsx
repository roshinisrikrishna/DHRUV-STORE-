...
//added to customize the SignIn page
...
const Login = () => {
  ...
  //adding following state initializations to customize login page
...
// React Hook Form configuration - changed to customize
const {
  register,
  handleSubmit,
...
// Function to show the password reset form - specially added functionality to be included in our customization
const forgotPassword = () => {
  setShowForm(true);
};


// Function to handle password reset - specially added functionality to be included in our customization
...
//basic onSubmit function for basic medusajs store template
  ...
  // })
    ...
    // Function to handle form submission - changed onSubmit function based on our customization
const onSubmit = handleSubmit(async (credentials) => {
  try {
    // Check if the customer already exists
...
//useEffect newly added for our customized login page
useEffect(() => {
