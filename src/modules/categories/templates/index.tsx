...
//include additional imports for customized categories page UI
...
import { ProductVariant, ProductOption } from "@medusajs/product"
...
//included additional type for customized category template
interface Category {
  id: string | number;
  name: string;
  handle: string;
...
//additional functions for customized category page
...
//changed whole categoryTemplate component according to customized category page
const CategoryTemplate: React.FC<CategoryTemplateProps> = ({ categories }) => {
  ...
  const modifiedCategoryName = capitalizeWords(modifyNames([category.name])[0]);
